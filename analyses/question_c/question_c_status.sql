...
(
    select
        ...
        , row_number() over (partition by base_orders.order_status order by valor_total_negociado desc, count(base_orders.order_id) desc) as valor_total_negociado_rank
    from base_orders

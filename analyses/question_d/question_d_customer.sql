...
(
    select
        ...
        , row_number() over (partition by base_customer.customer_name order by valor_total_negociado desc, count(base_orders.order_id) desc) as valor_total_negociado_rank
    from base_orders

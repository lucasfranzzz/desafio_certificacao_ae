...
(
    select
        ...
        , cast(orderqty as number(38,2)) as order_detail_qty
        , cast(productid as integer) as order_product_id
        , cast(specialofferid as integer) as order_special_offer_id
        , cast(unitprice as number(38,2)) as order_unit_price
        , cast(unitpricediscount as number(38,2)) as order_unit_price_discount

...
(
    select
        ...
        , cast(subtotal as number(38,2)) as order_subtotal
        , cast(taxamt as number(38,2)) as order_tax_amt
        , cast(freight as number(38,2)) as order_freight
        , cast(totaldue as number(38,2)) as order_total_due
